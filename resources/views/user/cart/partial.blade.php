                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-1 text-sm text-gray-500 space-y-1">
                                    ...
                                    <p><span class="font-medium">Bidang:</span> {{ ucfirst($item->bidang) }}</p>
                                    @if($item->keterangan)
                            ...
                            <div class="flex items-center space-x-2">
                                <button onclick="showEditModal({{ $item->id }}, '{{ $item->barang->nama_barang }}', {{ $item->quantity }}, '{{ $item->bidang }}', '{{ $item->keterangan }}', {{ $item->barang->stok }}, '{{ $item->barang->satuan }}')"
