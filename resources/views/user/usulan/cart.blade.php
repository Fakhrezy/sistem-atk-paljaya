            ...
            <form id="editForm">
                ...
                <div class="flex justify-end space-x-3">
                    <button type="button" onclick="closeEditModal()"
                        class="px-4 py-2 text-base font-medium text-gray-700 transition duration-150 ease-in-out bg-gray-300 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300">
                        Batal
                    </button>
                    <button type="button" onclick="updateItem()"
                        class="px-4 py-2 text-base font-medium text-white transition duration-150 ease-in-out bg-blue-500 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Simpan
                    </button>
                </div>
            </form>
