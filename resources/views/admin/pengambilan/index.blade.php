    ...
    <div class="max-w-full">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div class="w-full p-6 text-gray-900">
                ...
                <!-- Search and Filter -->
                <div class="mb-6">
                    <form action="{{ route('admin.pengambilan.index') }}" method="GET" class="flex flex-col gap-4 sm:flex-row">
...
<!-- Add to Cart Modal -->
<div id="addToCartModal" class="fixed inset-0 z-50 items-center justify-center hidden w-full h-full p-4 overflow-y-auto bg-black bg-opacity-50">
...
function addToCart() {
    ...
    // Confirm dialog before adding to cart
    Swal.fire({
        title: 'Tambah ke Keranjang?',
        text: `Apakah Anda yakin ingin menambahkan ${formData.get('quantity')} ${document.getElementById('satuan').textContent} barang ini ke keranjang?`,
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#16a34a',
        cancelButtonColor: '#6b7280',
        confirmButtonText: '<i class="mr-2 fas fa-cart-plus"></i>Ya, Tambahkan',
        ...
        if (result.isConfirmed) {
            ...
            addBtn.innerHTML = `<i class="mr-2 fas fa-spinner fa-spin"></i>Menambahkan...`;
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        title: 'Berhasil!',
                        text: data.message || 'Barang berhasil ditambahkan ke keranjang',
                        icon: 'success',
                        confirmButtonColor: '#16a34a',
            ...
            .finally(() => {
                ...
                addBtn.innerHTML = `<i class="mr-2 fas fa-cart-plus"></i>Tambah ke Keranjang`;
            });
        }
    });
}
