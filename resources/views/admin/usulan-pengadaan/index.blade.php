...
@section('header', 'SISTEM MONITORING BARANG HABIS PAKAI')
    ...
    <div class="max-w-full">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
            <div class="w-full p-6 text-gray-900">
                ...
                <!-- Search and Filter -->
                <div class="mb-6">
                    <form action="{{ route('admin.usulan.index') }}" method="GET" class="flex flex-col gap-4 sm:flex-row">
                                    ...
                                    <div class="mb-4 space-y-2">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="text-sm font-bold
                                                ...
                                                @elseif($item->stok > 0) text-yellow-600
                                                @else text-red-600
                                                @endif">
                                                {{ $item->stok }}
                                            </span>
