<div id="cart-content">
    ...
    <div class="py-12 text-center">
        ...
        <h2 class="flex items-center justify-center mb-2 text-xl font-semibold text-gray-600">
            <i class="mr-2 text-blue-500 fas fa-info-circle"></i>Belum Ada Barang untuk Diambil
        </h2>
        <p class="mb-6 text-gray-500">Silahkan tambahkan barang ke dalam keranjang</p>
